...
from data_transformer import DataTrans , DataTransConfig
from model_trainer import ModelTrainer , ModelTrainingConfig
@dataclass

class DataIngestionconfig:
    train_data_path:str=os.path.join('files','train.csv')
    test_data_path:str=os.path.join('files','test.csv')
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df=pd.read_csv('Notebook/student_addiction.csv')
